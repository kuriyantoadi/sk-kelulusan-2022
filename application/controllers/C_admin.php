...
class C_admin extends CI_Controller {
	...
	public function siswa_hapus($id_siswa)
  {
	...
	{
		$data['tampil'] = $this->M_admin->siswa_print($id_siswa);
		$this->load->view('admin/siswa_print', $data);
	}
	...
	public function siswa_edit_up()
	{
		...
		redirect ('C_admin/siswa_detail/'.$id_siswa);
	}

	public function siswa_pass($id_siswa)
	{
		$data['tampil'] = $this->M_admin->siswa_pass($id_siswa);
	...
	public function siswa_pass_up()
	{
		...
		$this->M_admin->siswa_pass_up($data_edit, $kode_siswa);
