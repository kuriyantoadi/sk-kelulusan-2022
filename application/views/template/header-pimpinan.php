  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="<?= base_url() ?>C_user/dashboard"><img src="<?= base_url() ?>assets/images/logo-dashboard.png" alt=""/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>C_pimpinan/dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>C_pimpinan/data_umkm">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>C_pimpinan/data_user">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>C_pimpinan/komoditi">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>C_pimpinan/data_pemesanan">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= base_url() ?>C_pimpinan/data_konfirmasi">
              <i class="mdi mdi-message-text-outline  menu-icon"></i>
              <span class="menu-title">Laporan Pengiriman</span>
            </a>
          </li>
