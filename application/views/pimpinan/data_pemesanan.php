             ...
             ?>
              ...
              <tr>
                ...
                <td><center>
                  ...
                  <a href="<?php echo site_url('C_pimpinan/bukti_pesanan/'.$row->kode_pesanan) ?>" class="btn btn-sm btn-warning">Cetak</a>
                  <a href="<?php echo site_url('C_pimpinan/data_pemesanan_detail/'.$row->kode_pesanan); ?>" class="btn btn-sm btn-info">Detail</a>
                </td>
              </tr>
              <?php } ?>
            </table>
