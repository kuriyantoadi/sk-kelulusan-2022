              ...
              <tr>
                ...
                <td><center>
                  <?php if ($status_kode == 'Dalam Pengiriman') { ?>
                    <a href="<?php echo site_url('C_pimpinan/konfirmasi_pesanan_diterima/'.$row->kode_pesanan); ?>" class="btn btn-sm btn-primary">Diterima</a>
                  <?php }elseif ($status_kode == 'Sudah diterima') { ?>
                    <a href="<?php echo site_url('C_pimpinan/konfirmasi_pesanan_riwayat/'.$row->kode_pesanan); ?>" class="btn btn-sm btn-info">Riwayat</a>
                  <?php } ?>
